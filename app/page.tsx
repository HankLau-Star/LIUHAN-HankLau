...
const soundtrackUrl = "https://cdn.pixabay.com/audio/2025/09/27/audio_ee5ecf71ba.mp3";
const soundtrackPage = "https://pixabay.com/music/upbeat-phonk-montagem-411215/";
    ...
    <>
      ...
      <header className="site-header">
        ...
        <div className="header-actions">
          <button className={musicPlaying ? "music-toggle is-playing" : "music-toggle"} type="button" aria-label={musicPlaying ? "暂停背景音乐" : "播放背景音乐"} aria-pressed={musicPlaying} onClick={toggleSoundtrack} title="PHONK MONTAGEM — kawaiiwork / Pixabay">
            <span aria-hidden="true"><i /><i /><i /><i /></span><b>{musicPlaying ? "REMIX ON" : "REMIX OFF"}</b>
          </button>
      ...
      <footer className="site-footer">
        ...
        <div><span>© 2026</span><a href={soundtrackPage} target="_blank" rel="noreferrer" className="music-credit">MUSIC · KAWAIIWORK / PIXABAY</a><a href="/admin" className="admin-entry">CONTENT CONSOLE</a><a href="#top">BACK TO TOP ↑</a></div>
      </footer>
    </>
  );
}
