...
export function normalizeSiteContent(value: unknown): SiteContent {
  ...
  return {
    ...
    spiritualAssets: cleanList(source.spiritualAssets, defaultSiteContent.spiritualAssets, 100, ["url", "mediaUrl"]),
    physicalAssets: cleanList(source.physicalAssets, defaultSiteContent.physicalAssets, 100, ["url", "mediaUrl"]),
    workAssets: cleanList(source.workAssets, defaultSiteContent.workAssets, 100, ["url", "mediaUrl"]),
