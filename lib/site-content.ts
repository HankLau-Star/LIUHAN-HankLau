...
export const defaultSiteContent: SiteContent = {
  ...
  platforms: [
    { name: "视频号", value: "16,000", detail: "200W+ 爆款播放" },
    { name: "Instagram", value: "5,000", detail: "190W+ 爆款播放" },
    { name: "抖音 · 双账号", value: "5,300", detail: "180W+ / 300W+ 流量作品" },
    { name: "微博", value: "3,000", detail: "持续内容沉淀" },
    { name: "知乎", value: "1,400", detail: "多篇高赞原创" },
    { name: "小红书", value: "1,100", detail: "内容矩阵分发" },
